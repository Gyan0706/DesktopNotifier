news_item = {
    'description': (
        "Months after it was first reported, the feud between Dwayne Johnson and "
    ...
    'link': (
        "http://www.hindustantimes.com/hollywood/vin-diesel-dwayne-johnson-feud-rages-"
        "on-they-re-being-kept-apart-for-fast-8-tour/story-Bwl2Nx8gja9T15aMvcrcvL.html"
    ),
    'media': (
        "http://www.hindustantimes.com/rf/image_size_630x354/HT/p2/2017/04/01/Pictures/"
